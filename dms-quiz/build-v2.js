...
const rawText = fs.readFileSync('data-v2.txt', 'utf8');
...
const scriptContent = `// DMS 問題集データ v2 (自動生成) - 解説表示UI付き
...
fs.writeFileSync('script-v2.js', scriptContent, 'utf8');
console.log('Successfully generated script-v2.js');
