...
const EditableCell = ({ value, onChange, placeholder = "入力...", className = "" }) => {
  ...
  return (
    <div
      ...
      className={`w-full min-h-[60px] p-2 text-sm rounded-md cursor-pointer hover:bg-gray-50 border border-transparent hover:border-gray-300 transition-colors whitespace-pre-wrap flex items-start ${!currentValue ? 'text-gray-300 italic' : 'text-gray-800'} ${className}`}
    >
